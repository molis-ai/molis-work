...
import { renderShelfContribution } from "./ui-composition.js";
...
import { PROJECT_GUIDANCE_CLIENT_SCRIPT, RUNTIME_PLAN_CLIENT_SCRIPT, WEB_SERVICE_SETTINGS_SCRIPT } from "./browser-assets.js";
...
function renderMolisWorkWorkbenchStylesheet(): string {
  return `${STYLES}${MORE_STYLES}${RESPONSIVE_STYLES}${VISUAL_FOUNDATION_STYLES}${TRASH_GOAL_STYLES}${PROJECT_OPERATIONS_STYLES}${ARTIFACT_EMBED_STYLES}${ARTIFACT_WORKBENCH_STYLES}${IMMERSIVE_NAVIGATION_STYLES}${IMMERSIVE_DIRECTORY_STYLES}${PROJECT_HOME_STYLES}${GOAL_CANVAS_STYLES}${TAB_WORKSPACE_STYLES}${DETAIL_READING_STYLES}${PROJECT_GUIDANCE_SETTINGS_STYLES}${PROJECT_RULES_SETTINGS_STYLES}${PLANNING_SETTINGS_STYLES}${SETTINGS_STYLES}${PROJECT_SETTINGS_PAGE_STYLES}.document-pane.is-syncing .goal-document { animation: none; }${COSS_CONTROL_STYLES}${SURFACE_LANGUAGE_STYLES}${LINEAR_DENSITY_STYLES}${INTERACTION_TEXTURE_STYLES}${PRIMITIVE_STYLES}${SHELF_STYLES}${TYPEFACE_STYLES}`;
}
...
function renderMolisWorkProjectIndexStylesheet(): string {
  return `${STYLES}${VISUAL_FOUNDATION_STYLES}${PROJECT_INDEX_STYLES}${COSS_CONTROL_STYLES}${SURFACE_LANGUAGE_STYLES}${INTERACTION_TEXTURE_STYLES}${PRIMITIVE_STYLES}${TYPEFACE_STYLES}`;
}
