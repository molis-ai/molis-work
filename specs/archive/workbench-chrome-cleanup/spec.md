...
- 点 Feed 仍 `setDesktopDirectory("feed")`，左栏切到空的 `data-directory-panel="feed"`；列表实际在 `[data-feed-stage-directory]`。`specs/archive/feed-stage-directory/spec.md` 已规定左边只留目的地。
