...
本文件是本次体验变更的唯一需求书。它补在 `specs/archive/home-directory-visual-unify/spec.md` 之上：Feed 仍用 44px 两行；Sessions 不再跟 Feed，改跟 Goals。
...
- 不完成 `specs/archive/directory-plugin-sections/spec.md` 的其余工作。
...
- `specs/archive/home-directory-visual-unify/spec.md` 中 Sessions 行高约定
