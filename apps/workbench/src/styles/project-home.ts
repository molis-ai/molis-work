...
export const PROJECT_HOME_STYLES = `
  ...
  .immersive-home .project-home-content { width: 100%; max-width: 670px; min-height: 100%; margin: 0 auto; display: flex; flex-direction: column; justify-content: flex-start; align-items: stretch; gap: 28px; }
  .immersive-home .home-context { display: grid; grid-template-columns: minmax(0, 1fr) 200px; align-items: start; gap: 32px; width: 100%; margin: 0; flex: none; }
  .immersive-home .home-date-year { font-size: 12px; color: var(--muted); margin: 0 0 8px; }
  .immersive-home .home-today { display: flex; flex-wrap: wrap; align-items: baseline; gap: 12px; margin: 0; color: var(--ink); }
  .immersive-home .home-today time { font-size: 30px; font-weight: 400; letter-spacing: -.035em; line-height: 1.3; }
  .immersive-home .home-today > span { font-size: 13px; font-weight: 400; color: var(--ink-soft); }
  ...
  .immersive-home [data-home-month] { font-size: 12px; font-weight: 400; }
  ...
  .immersive-home .home-calendar table { width: 100%; table-layout: fixed; border-collapse: collapse; text-align: center; font-size: 12px; }
  .immersive-home .home-calendar th { height: 25px; padding: 0; font-weight: 400; color: var(--muted); border: 0; }
  .immersive-home .home-calendar td { height: 27px; padding: 0; border: 0; color: var(--ink-soft); }
  .immersive-home .home-calendar td span { width: 25px; height: 25px; display: inline-grid; place-items: center; border-radius: 50%; }
  .immersive-home .home-calendar td.home-calendar-outside { color: var(--faint); }
  .immersive-home .home-calendar td[aria-current="date"] span { background: var(--action); color: var(--action-ink); font-weight: 400; }
  ...
  .immersive-home .home-composer { display: flex; align-items: center; gap: 12px; width: 100%; height: 52px; padding: 8px 12px 8px 16px; border: 1px solid var(--line-strong); border-radius: 23px; background: var(--paper); }
  .immersive-home .home-agent-icon { display: grid; place-items: center; flex: none; color: var(--muted); }
  .immersive-home .home-agent-icon svg { width: 16px; height: 16px; }
  .immersive-home .home-composer input { flex: 1; width: 100%; min-width: 0; padding: 6px 0; border: 0; background: transparent; color: var(--muted); font: inherit; font-size: 14px; -webkit-text-fill-color: var(--muted); cursor: not-allowed; }
  .immersive-home .home-composer input::placeholder { color: var(--muted); opacity: 1; }
  .immersive-home .home-send { flex: none; display: grid; place-items: center; width: 28px; height: 28px; padding: 0; border: 0; border-radius: 8px; background: var(--nav-active); color: var(--muted); cursor: not-allowed; }
  .immersive-home .home-send svg { width: 15px; height: 15px; transform: rotate(-90deg); }
  .immersive-home .home-agent-note { display: flex; align-items: center; justify-content: flex-start; gap: 6px; margin: 12px 0 0; color: var(--ink-soft); font-size: 12px; }
  ...
  @container plugin-stage (max-width: 450px) {
    ...
    .immersive-home .project-home-content { gap: 24px; }
