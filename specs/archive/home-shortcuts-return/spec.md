...
- `specs/archive/directory-shortcuts/spec.md` 里「快捷方式在左侧目录」；
- `specs/archive/directory-plugin-sections/spec.md` 里「快捷方式在分段下面一起滚、不收进插件」。

存储、校验、外链、弹窗语义仍以 `specs/archive/poetic-project-home/spec.md` 为准。目录分段语法仍以 `specs/archive/directory-plugin-sections/spec.md` 为准，只不再挂快捷方式。
...
- `specs/archive/directory-plugin-sections/spec.md`、`specs/archive/directory-shortcuts/spec.md`
