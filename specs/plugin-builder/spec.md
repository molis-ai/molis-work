...
状态：方案草案，待评审；尚未实现。日期：2026-09-22。

本次工作：新建 `codex/plugin-builder-plan` 分支并形成方案。代码核对基线为 `721e13198611e220b91461699c52be0e755b91f6`。本文是本功能的需求与验收依据；实现接缝见 [技术设计](design.md)。方案中的“采用”“需要”表示拟议决定，不表示现有能力。
...
画布既承载候选比较，也承载实际可交互的页面。组件树、属性与绑定信息按需展开，普通用户不必通过连线编辑器配置每个行为。
