...
export const WORKSPACE_PACKAGES = [
  entry("apps/desktop", "@molis-ai/molis-work-app-desktop", "app", "@molis-ai/molis-work-contracts/platform/app-host", ["goal-reorg-ap4", "goal-reorg-dv4"], "Molis Work macOS product shell and native bridge composition root.", "Business facts, Module rules, or Runtime state.", ["desktop/", "src/desktop/"], { maturity: "partial", capabilities: ["desktop.shell.v1", "desktop.runtime-launch.v1", "desktop.advance-prompt.v1", "desktop.panels.v1", "desktop.capsule-shell.v1"], extraWorkspaceDependencies: ["@molis-ai/molis-work-service-runtime-host", "@molis-ai/molis-work-storage", "@molis-ai/molis-work-plugin-feed", "@molis-ai/molis-work-app-local-host"] }),
  entry("apps/workbench", "@molis-ai/molis-work-app-workbench", "app", "@molis-ai/molis-work-contracts/platform/app-host", ["goal-reorg-fd4", "goal-reorg-ap3", "goal-reorg-gw4", "goal-reorg-gw5", "goal-reorg-ex4"], "Local product UI composition root for the Workbench.", "Business Stores, Node-only implementations, or Tauri commands.", ["src/web/"], { maturity: "partial", capabilities: ["workbench.shell.v1", "workbench.ui-slots.v1", "workbench.feed-composition.v1", "workbench.goals-command-adapter.v1", "workbench.work-composition.v1", "workbench.goals-policy-composition.v1", "workbench.goals-safety-composition.v1", "workbench.goals-relation-composition.v1", "workbench.goals-tree-composition.v1", "workbench.goals-momentum-composition.v1", "workbench.goals-document-composition.v1", "workbench.goals-context-composition.v1", "workbench.goals-planning-composition.v1", "workbench.goals-status-composition.v1", "workbench.goals-factors-composition.v1", "workbench.goals-dialogs-composition.v1", "workbench.goals-document-routes.v1"], extraWorkspaceDependencies: ["@molis-ai/molis-work-plugin-artifacts", "@molis-ai/molis-work-plugin-coding", "@molis-ai/molis-work-plugin-goals", "@molis-ai/molis-work-plugin-feed", "@molis-ai/molis-work-plugin-functions", "@molis-ai/molis-work-plugin-form", "@molis-ai/molis-work-plugin-pages", "@molis-ai/molis-work-plugin-lingguang", "@molis-ai/molis-work-plugin-dataset", "@molis-ai/molis-work-plugin-ppt", "@molis-ai/molis-work-plugin-inbox", "@molis-ai/molis-work-plugin-schedule", "@molis-ai/molis-work-plugin-shelf", "@molis-ai/molis-work-plugin-work", "@molis-ai/molis-work-plugin-workspace", "@molis-ai/molis-work-plugin-files", "@molis-ai/molis-work-plugin-git", "@molis-ai/molis-work-plugin-diff", "@molis-ai/molis-work-plugin-text-stats", "@molis-ai/molis-work-ui-host", "@molis-ai/molis-work-design-system", "@molis-ai/molis-work-integration-rss", "@molis-ai/molis-work-integration-gmail"] }),
  entry("apps/local-host", "@molis-ai/molis-work-app-local-host", "app", "@molis-ai/molis-work-contracts/platform/app-host", ["goal-reorg-ap2"], "The single local composition root for Modules, services, plugins, and storage.", "A second business coordinator or user-facing product shell.", ["apps/desktop/launchers/web/server.ts", "src/cli/", "src/mcp/"], { maturity: "partial", extraDependencies: { "ws": "^8.21.3", "@adeptify/search-evidence-layer": "file:../../vendor/search-evidence-layer/adeptify-search-evidence-layer-0.4.1.tgz", "@adeptify/intelligence-client": "file:../../vendor/intelligence-client/adeptify-intelligence-client-0.2.2.tgz" }, capabilities: ["local-host.client.v1", "local-host.single-writer.v1"], extraWorkspaceDependencies: ["@molis-ai/molis-work-app-cli", "@molis-ai/molis-work-app-mcp", "@molis-ai/molis-work-app-workbench", "@molis-ai/molis-work-design-system", "@molis-ai/molis-work-integration-github", "@molis-ai/molis-work-integration-gmail", "@molis-ai/molis-work-integration-rss", "@molis-ai/molis-work-integration-youtube", "@molis-ai/molis-work-kernel", "@molis-ai/molis-work-module-artifacts", "@molis-ai/molis-work-module-attention-resumption", "@molis-ai/molis-work-module-context-ledger", "@molis-ai/molis-work-module-evidence-verification", "@molis-ai/molis-work-module-execution", "@molis-ai/molis-work-module-feed", "@molis-ai/molis-work-module-functions", "@molis-ai/molis-work-module-goals", "@molis-ai/molis-work-module-governance-collaboration", "@molis-ai/molis-work-module-private-work-context", "@molis-ai/molis-work-module-projects", "@molis-ai/molis-work-module-shelf", "@molis-ai/molis-work-module-signals", "@molis-ai/molis-work-module-sources", "@molis-ai/molis-work-plugin-artifacts", "@molis-ai/molis-work-plugin-coding", "@molis-ai/molis-work-plugin-diff", "@molis-ai/molis-work-plugin-feed", "@molis-ai/molis-work-plugin-files", "@molis-ai/molis-work-plugin-functions", "@molis-ai/molis-work-plugin-form", "@molis-ai/molis-work-plugin-pages", "@molis-ai/molis-work-plugin-lingguang", "@molis-ai/molis-work-plugin-dataset", "@molis-ai/molis-work-plugin-ppt", "@molis-ai/molis-work-plugin-git", "@molis-ai/molis-work-plugin-goals", "@molis-ai/molis-work-plugin-inbox", "@molis-ai/molis-work-plugin-runtime", "@molis-ai/molis-work-plugin-schedule", "@molis-ai/molis-work-plugin-shelf", "@molis-ai/molis-work-plugin-text-stats", "@molis-ai/molis-work-plugin-work", "@molis-ai/molis-work-plugin-workspace", "@molis-ai/molis-work-service-agent-host", "@molis-ai/molis-work-service-connector-host", "@molis-ai/molis-work-service-listener-host", "@molis-ai/molis-work-service-runtime-host", "@molis-ai/molis-work-service-scheduler", "@molis-ai/molis-work-storage", "@molis-ai/molis-work-ui-host"] }),
  entry("apps/cli", "@molis-ai/molis-work-app-cli", "app", "@molis-ai/molis-work-contracts/platform/app-host", ["goal-reorg-dv1", "goal-reorg-gw4", "goal-reorg-ex4"], "Thin CLI protocol, argument, and presentation adapter.", "Business decisions, Module Stores, or duplicated application rules.", ["src/cli/"], { maturity: "partial", capabilities: ["cli.goals-command-adapter.v1"], extraWorkspaceDependencies: ["@molis-ai/molis-work-plugin-goals"] }),
  entry("apps/mcp", "@molis-ai/molis-work-app-mcp", "app", "@molis-ai/molis-work-contracts/platform/app-host", ["goal-reorg-dv1", "goal-reorg-dv2", "goal-reorg-gw4", "goal-reorg-ex4"], "Thin MCP schema, audience, and capability adapter.", "Business rules, direct Store access, or Runtime Skill policy.", ["src/mcp/"], { maturity: "partial", capabilities: ["mcp.goals-command-adapter.v1"], extraWorkspaceDependencies: ["@molis-ai/molis-work-plugin-goals"] }),
...
entry("modules/context-ledger", "@molis-ai/molis-work-module-context-ledger", "module", "@molis-ai/molis-work-contracts/modules/context-ledger", ["goal-reorg-ar2"], "Object references, cross-owner relationships, publication, and materialization records.", "The referenced Goal, Artifact, Feed, or Session content.", ["src/v1/coordinator.ts", "src/feed/", "src/sessions/"], { maturity: "partial", capabilities: ["context.edges.v1"] }),
  ...
  entry("modules/functions", "@molis-ai/molis-work-module-functions", "module", "@molis-ai/molis-work-contracts/modules/functions", [], "Published functions and judgment records.", "TypeSafe HTTP, plugin UI, or scene execution.", [], { maturity: "partial", capabilities: ["functions.query.v1", "functions.command.v1", "functions.evaluate"] }),
  entry("modules/evidence-verification", "@molis-ai/molis-work-module-evidence-verification", "module", "@molis-ai/molis-work-contracts/modules/evidence-verification", ["goal-reorg-ex2", "goal-reorg-ex4"], "Evidence, immutable corrections, criterion coverage, and verification obligations.", "Artifact bodies, Goal Contracts, Runs, or Review verdicts.", ["src/v1/", "src/evidence/"], { maturity: "partial", capabilities: ["evidence.records.v1", "evidence.locator-preflight.v1"] }),
  ...
  entry("plugins/native/pages", "@molis-ai/molis-work-plugin-pages", "native-plugin", "@molis-ai/molis-work-contracts/platform/plugin", [], "Protected first-party Pages directory and ProseMirror document editor.", "Goal/Artifact facts, model providers, or a hosted document service.", ["src/web/render.ts"], { extraWorkspaceDependencies: ["@molis-ai/molis-work-design-system"], maturity: "partial", capabilities: ["pages.ui-contribution.v1", "pages.http-routes.v1"], extraDependencies: { "prosemirror-commands": "^1.7.1", "prosemirror-history": "^1.5.0", "prosemirror-inputrules": "^1.5.1", "prosemirror-keymap": "^1.2.3", "prosemirror-model": "^1.25.4", "prosemirror-schema-list": "^1.5.1", "prosemirror-state": "^1.4.4", "prosemirror-view": "^1.41.4" } }),
  entry("plugins/native/form", "@molis-ai/molis-work-plugin-form", "native-plugin", "@molis-ai/molis-work-contracts/platform/plugin", [], "Protected first-party Forms directory, questions, preview, and results.", "Goal/Artifact facts, model providers, or a hosted form collector.", ["src/web/render.ts"], { extraWorkspaceDependencies: ["@molis-ai/molis-work-design-system"], maturity: "partial", capabilities: ["form.ui-contribution.v1", "form.http-routes.v1"] }),
  entry("plugins/native/dataset", "@molis-ai/molis-work-plugin-dataset", "native-plugin", "@molis-ai/molis-work-contracts/platform/plugin", [], "Protected first-party Dataset directory, table editing, CSV, and versions.", "Goal/Artifact facts, model providers, or a hosted spreadsheet.", ["src/web/render.ts"], { extraWorkspaceDependencies: ["@molis-ai/molis-work-design-system"], maturity: "partial", capabilities: ["dataset.ui-contribution.v1", "dataset.http-routes.v1"] }),
  entry("plugins/native/ppt", "@molis-ai/molis-work-plugin-ppt", "native-plugin", "@molis-ai/molis-work-contracts/platform/plugin", [], "Protected first-party PPT directory, slide outlines, preview, and JSON export.", "Goal/Artifact facts, SVG generation, or PPTX export.", ["src/web/render.ts"], { extraWorkspaceDependencies: ["@molis-ai/molis-work-design-system"], maturity: "partial", capabilities: ["ppt.ui-contribution.v1", "ppt.http-routes.v1"] }),
  entry("plugins/native/lingguang", "@molis-ai/molis-work-plugin-lingguang", "native-plugin", "@molis-ai/molis-work-contracts/platform/plugin", [], "Protected first-party Lingguang directory and inspiration pool.", "Goal/Artifact facts, model providers, or a hosted inspiration service.", ["src/web/render.ts"], { extraWorkspaceDependencies: ["@molis-ai/molis-work-design-system"], maturity: "partial", capabilities: ["lingguang.ui-contribution.v1", "lingguang.http-routes.v1"] }),
