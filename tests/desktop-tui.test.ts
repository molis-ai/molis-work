...
test("Web and Desktop share one project workbench; Desktop only adds native chrome hooks", () => {
  ...
  try {
    ...
    assert.match(desktop, /data-directory-open="feed" data-work-surface-open="feed" data-feed-preset="feed"/);
    assert.match(desktop, /data-directory-open="sources" data-work-surface-open="sources"/);
