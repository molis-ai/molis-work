...
export const DETAIL_READING_STYLES = `
  ...
  body.immersive-workbench .inbox-reference-detail > .feed-detail-header { flex: none; padding: 16px 20px 8px; }
  ...
  @media (max-width: 760px) {
    body.immersive-workbench .inbox-reference-detail > .feed-detail-header { padding: 16px 16px 8px; }
