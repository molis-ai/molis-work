...
export const WORKSPACE_PACKAGES = [
  entry("apps/server", "@molis-ai/molis-work-app-server", "app", "@molis-ai/molis-work-contracts/platform/app-host", [], "Headless standalone server launcher, original Host action bridge and local asset restore adapter.", "A second model Runtime, Goal or Artifact facts, or desktop window startup.", [], { maturity: "partial", extraWorkspaceDependencies: ["@molis-ai/molis-work-server", "@molis-ai/molis-work-storage", "@molis-ai/molis-work-app-local-host", "@molis-ai/molis-work-im-ui", "@molis-ai/molis-work-app-desktop", "@molis-ai/molis-work-plugin-runtime"] }),
  entry("server", "@molis-ai/molis-work-server", "foundation", "@molis-ai/molis-work-contracts/platform/app-host", [], "Shared identity, devices, project access, HTTP, SSE and continuity receipts.", "Goal or Artifact facts, model execution, or independent app launchers.", [], { maturity: "partial", extraWorkspaceDependencies: ["@molis-ai/molis-work-storage"] }),
  entry("packages/im-ui", "@molis-ai/molis-work-im-ui", "foundation", "@molis-ai/molis-work-contracts/services/im", [], "Shared group chat and inline Thread UI.", "Server identity, durable messages, or synchronization implementation.", [], { maturity: "partial", extraWorkspaceDependencies: ["@molis-ai/molis-work-design-system"] }),
  entry("packages/plugin-sandbox", "@molis-ai/molis-work-plugin-sandbox", "foundation", "@molis-ai/molis-work-contracts/platform/plugin-sandbox", [], "macOS process isolation and asynchronous host mediation for generated plugins.", "Plugin product state or model execution.", [], { maturity: "partial" }),
  ...
  entry("apps/workbench", "@molis-ai/molis-work-app-workbench", "app", "@molis-ai/molis-work-contracts/platform/app-host", ["goal-reorg-fd4", "goal-reorg-ap3", "goal-reorg-gw4", "goal-reorg-gw5", "goal-reorg-ex4"], "Local product UI composition root for the Workbench.", "Business Stores, Node-only implementations, or Tauri commands.", ["src/web/"], { maturity: "partial", capabilities: ["workbench.shell.v1", "workbench.ui-slots.v1", "workbench.feed-composition.v1", "workbench.work-composition.v1", "workbench.goals-policy-composition.v1", "workbench.goals-safety-composition.v1", "workbench.goals-relation-composition.v1", "workbench.goals-tree-composition.v1", "workbench.goals-momentum-composition.v1", "workbench.goals-document-composition.v1", "workbench.goals-context-composition.v1", "workbench.goals-planning-composition.v1", "workbench.goals-status-composition.v1", "workbench.goals-factors-composition.v1", "workbench.goals-dialogs-composition.v1", "workbench.goals-document-routes.v1"], extraWorkspaceDependencies: ["@molis-ai/molis-work-im-ui", "@molis-ai/molis-work-plugin-artifacts", "@molis-ai/molis-work-plugin-characters", "@molis-ai/molis-work-plugin-coding", "@molis-ai/molis-work-plugin-goals", "@molis-ai/molis-work-plugin-feed", "@molis-ai/molis-work-plugin-experiments", "@molis-ai/molis-work-plugin-images", "@molis-ai/molis-work-plugin-jelly", "@molis-ai/molis-work-plugin-cognia", "@molis-ai/molis-work-plugin-form", "@molis-ai/molis-work-plugin-pages", "@molis-ai/molis-work-plugin-lingguang", "@molis-ai/molis-work-plugin-workflows", "@molis-ai/molis-work-plugin-alchemist", "@molis-ai/molis-work-plugin-builder", "@molis-ai/molis-work-plugin-dataset", "@molis-ai/molis-work-plugin-ppt", "@molis-ai/molis-work-plugin-inbox", "@molis-ai/molis-work-plugin-schedule", "@molis-ai/molis-work-plugin-shelf", "@molis-ai/molis-work-plugin-work", "@molis-ai/molis-work-plugin-workspace", "@molis-ai/molis-work-plugin-files", "@molis-ai/molis-work-plugin-git", "@molis-ai/molis-work-plugin-diff", "@molis-ai/molis-work-plugin-text-stats", "@molis-ai/molis-work-ui-host", "@molis-ai/molis-work-design-system", "@molis-ai/molis-work-integration-rss", "@molis-ai/molis-work-integration-gmail"] }),
  entry("apps/local-host", "@molis-ai/molis-work-app-local-host", "app", "@molis-ai/molis-work-contracts/platform/app-host", ["goal-reorg-ap2"], "The single local composition root for Modules, services, plugins, and storage.", "A second business coordinator or user-facing product shell.", ["apps/desktop/launchers/web/server.ts", "src/cli/", "src/mcp/"], { maturity: "partial", extraDependencies: { "node-pty": "^1.1.0", "@modelcontextprotocol/sdk": "^1.30.1", "typescript": "^5.8.0", "pdfjs-dist": "6.3.289", "esbuild": "^0.28.2", "ws": "^8.21.3", "@adeptify/search-evidence-layer": "file:../../vendor/search-evidence-layer/adeptify-search-evidence-layer-0.4.1.tgz", "@adeptify/intelligence-client": "file:../../vendor/intelligence-client/adeptify-intelligence-client-0.2.2.tgz" }, capabilities: ["local-host.client.v1", "local-host.single-writer.v1"], extraWorkspaceDependencies: ["@molis-ai/molis-work-server", "@molis-ai/molis-work-im-ui", "@molis-ai/molis-work-plugin-sandbox", "@molis-ai/molis-work-app-cli", "@molis-ai/molis-work-app-mcp", "@molis-ai/molis-work-app-workbench", "@molis-ai/molis-work-design-system", "@molis-ai/molis-work-integration-catalog", "@molis-ai/molis-work-integration-github", "@molis-ai/molis-work-integration-gmail", "@molis-ai/molis-work-integration-rss", "@molis-ai/molis-work-integration-youtube", "@molis-ai/molis-work-kernel", "@molis-ai/molis-work-module-artifacts", "@molis-ai/molis-work-module-attention-resumption", "@molis-ai/molis-work-module-characters", "@molis-ai/molis-work-module-context-ledger", "@molis-ai/molis-work-module-evidence-verification", "@molis-ai/molis-work-module-execution", "@molis-ai/molis-work-module-feed", "@molis-ai/molis-work-module-functions", "@molis-ai/molis-work-module-goals", "@molis-ai/molis-work-module-governance-collaboration", "@molis-ai/molis-work-module-private-work-context", "@molis-ai/molis-work-module-projects", "@molis-ai/molis-work-module-shelf", "@molis-ai/molis-work-module-signals", "@molis-ai/molis-work-module-sources", "@molis-ai/molis-work-plugin-artifacts", "@molis-ai/molis-work-plugin-characters", "@molis-ai/molis-work-plugin-coding", "@molis-ai/molis-work-plugin-diff", "@molis-ai/molis-work-plugin-feed", "@molis-ai/molis-work-plugin-files", "@molis-ai/molis-work-plugin-experiments", "@molis-ai/molis-work-plugin-images", "@molis-ai/molis-work-plugin-jelly", "@molis-ai/molis-work-plugin-cognia", "@molis-ai/molis-work-plugin-form", "@molis-ai/molis-work-plugin-pages", "@molis-ai/molis-work-plugin-lingguang", "@molis-ai/molis-work-plugin-workflows", "@molis-ai/molis-work-plugin-alchemist", "@molis-ai/molis-work-plugin-builder", "@molis-ai/molis-work-plugin-dataset", "@molis-ai/molis-work-plugin-ppt", "@molis-ai/molis-work-plugin-git", "@molis-ai/molis-work-plugin-goals", "@molis-ai/molis-work-plugin-inbox", "@molis-ai/molis-work-plugin-runtime", "@molis-ai/molis-work-plugin-schedule", "@molis-ai/molis-work-plugin-shelf", "@molis-ai/molis-work-plugin-text-stats", "@molis-ai/molis-work-plugin-work", "@molis-ai/molis-work-plugin-workspace", "@molis-ai/molis-work-service-agent-host", "@molis-ai/molis-work-service-connector-host", "@molis-ai/molis-work-service-listener-host", "@molis-ai/molis-work-service-runtime-host", "@molis-ai/molis-work-service-scheduler", "@molis-ai/molis-work-storage", "@molis-ai/molis-work-ui-host"] }),  entry("apps/cli", "@molis-ai/molis-work-app-cli", "app", "@molis-ai/molis-work-contracts/platform/app-host", ["goal-reorg-dv1", "goal-reorg-gw4", "goal-reorg-ex4"], "Thin CLI protocol, argument, and presentation adapter.", "Business decisions, Module Stores, or duplicated application rules.", ["src/cli/"], { maturity: "partial", capabilities: [], extraWorkspaceDependencies: ["@molis-ai/molis-work-plugin-goals"] }),  entry("apps/mcp", "@molis-ai/molis-work-app-mcp", "app", "@molis-ai/molis-work-contracts/platform/app-host", ["goal-reorg-dv1", "goal-reorg-dv2", "goal-reorg-gw4", "goal-reorg-ex4"], "Thin MCP schema, audience, and capability adapter.", "Business rules, direct Store access, or Runtime Skill policy.", ["src/mcp/"], { maturity: "partial", capabilities: [], extraWorkspaceDependencies: ["@molis-ai/molis-work-plugin-goals"] }),
...
entry("modules/context-ledger", "@molis-ai/molis-work-module-context-ledger", "module", "@molis-ai/molis-work-contracts/modules/context-ledger", ["goal-reorg-ar2"], "Object references, cross-owner relationships, publication, and materialization records.", "The referenced Goal, Artifact, Feed, or Session content.", ["src/v1/coordinator.ts", "src/feed/", "src/sessions/"], { maturity: "partial", capabilities: ["context.edges.v1"] }),
  ...
  entry("plugins/native/cognia", "@molis-ai/molis-work-plugin-cognia", "native-plugin", "@molis-ai/molis-work-contracts/platform/plugin", [], "Personal knowledge import, reading and source-grounded synthesis.", "Source-vault mutations, project facts or a second runtime.", [], { extraWorkspaceDependencies: ["@molis-ai/molis-work-design-system", "@molis-ai/molis-work-storage"], maturity: "partial", capabilities: ["cognia.ui-contribution.v1", "cognia.knowledge.v1"] }),
  ...
  entry("plugins/native/workflows", "@molis-ai/molis-work-plugin-workflows", "native-plugin", "@molis-ai/molis-work-contracts/platform/plugin", [], "Project workflows that chain existing plugins with typed handoffs.", "Plugin item storage, model providers, or Feed/Inbox/Pages internals.", [], { extraWorkspaceDependencies: ["@molis-ai/molis-work-design-system", "@molis-ai/molis-work-storage"], maturity: "partial", capabilities: ["workflows.ui-contribution.v1", "workflows.http-routes.v1"] }),
  entry("plugins/native/plugin-builder", "@molis-ai/molis-work-plugin-builder", "native-plugin", "@molis-ai/molis-work-contracts/platform/plugin", [], "Prologue plugin design, assembly and independent applications.", "Model credentials, runtime ownership or arbitrary code execution.", [], { maturity: "partial", capabilities: ["plugin-builder.ui.v1", "plugin-builder.workflow.v1"], extraWorkspaceDependencies: ["@molis-ai/molis-work-design-system"] }),
  entry("plugins/native/alchemist", "@molis-ai/molis-work-plugin-alchemist", "native-plugin", "@molis-ai/molis-work-contracts/platform/plugin", [], "Project-isolated Alchemist studio: discovery, evidence-backed research and founder decisions.", "Host model credentials or another Plugin implementation.", ["src/web/render.ts"], { extraWorkspaceDependencies: ["@molis-ai/molis-work-design-system", "@molis-ai/molis-work-storage"], maturity: "partial", extraDependencies: { "better-sqlite3": "12.8.0", "hono": "4.12.32", "zod": "4.4.3" }, capabilities: ["alchemist.ui-contribution.v1", "alchemist.http-routes.v1"] }),
