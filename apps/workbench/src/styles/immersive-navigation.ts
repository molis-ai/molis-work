...
export const IMMERSIVE_NAVIGATION_STYLES = `
  ...
  html[data-resolved-theme="dark"] body.immersive-workbench :is(.workspace-chrome .navigator-project-primary, .plugin-rail-items, .plugin-rail .personal-sidebar-footer) {
