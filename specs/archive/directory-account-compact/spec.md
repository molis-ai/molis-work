...
本文件是本次视觉变更的唯一需求书。姓名分行、主题色、无下划线、设置入口仍遵守 `specs/archive/home-narrow-footer-quotes/spec.md`。覆盖 `specs/archive/directory-list-divider/spec.md` 里原先保留的账号区顶线。
...
- 账号行压矮的视觉合同仍有效。全局设置入口已改为插件栏底独立齿轮，见 `specs/archive/settings-directory-panel/spec.md`。
