...
本文件补 `specs/archive/plugin-stage-master-detail/spec.md`，缩进档位对齐 `specs/archive/goal-list-collection-indent/spec.md` 与 `specs/archive/session-list-runtime-indent/spec.md`。
...
不做：不改拉取 / 注意力 / Artifact 版本语义 / Shelf Job 语义、不改用户库。Sessions / Goals 已有合同，不重做。舞台 IA 见 `specs/archive/plugin-stage-master-detail/spec.md`。
