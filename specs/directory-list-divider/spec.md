...
本文件是本次视觉变更的唯一需求书。它覆盖 `specs/home-directory-visual-unify/spec.md` 里「目的地与列表分割线仍在」那一条。
...
- 侧栏与工作面之间的竖线保留。账号区顶线改由 `specs/directory-account-compact/spec.md` 去掉。
...
- `specs/home-directory-visual-unify/spec.md`（废止「分割线仍在」）
