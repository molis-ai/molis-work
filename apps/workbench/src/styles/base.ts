...
export const STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  .workspace.is-tui-collapsed .tui-expand:focus-visible { outline: 2px solid var(--focus); outline-offset: -2px; }
