...
- `specs/archive/directory-title-toolbar/spec.md` 里「折叠全部保留」；
- `specs/archive/global-plugin-search/spec.md` 里「折叠全部保留」；
- `specs/archive/directory-plugin-sections/spec.md` 里「折叠全部仍只折叠 Goal 节点」。
