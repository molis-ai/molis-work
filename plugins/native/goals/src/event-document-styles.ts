export const GOALS_EVENT_DOCUMENT_STYLES = `
  ...
  .goal-event-document .goal-title-heading h1 { margin: 0; font-size: 16px; line-height: 1.3; letter-spacing: -.02em; font-weight: 400; }
  ...
  .goal-event-document .mw-btn--link { display: inline-flex; gap: 5px; align-items: center; padding: 4px 6px; color: var(--ink-soft); font-size: 11px; background: none; border: 0; cursor: pointer; }
  ...
  .goal-event-document .overview-heading h2 { font-size: 12px; font-weight: 400; margin: 0; }
  ...
  .goal-event-document .overview-lead { font-size: 13px; font-weight: 400; margin: 5px 0 0; line-height: 1.65; }
  .goal-event-document .overview-grid { display: grid; grid-template-columns: 1fr 1.25fr 1fr; gap: 22px; margin-top: 11px; }
  .goal-event-document .overview-grid h3 { font-size: 10px; font-weight: 400; color: var(--muted); margin: 0 0 3px; }
  ...
  .goal-event-document .filters button[aria-pressed="true"] { color: var(--ink); background: var(--nav-active); font-weight: 400; }
  ...
  .goal-event-document .day-label { font-size: 10px; font-weight: 400; color: var(--muted); margin: 10px 8px 5px; }
  ...
  .goal-event-document .timeline-mark { z-index:1; display:grid; place-items:center; width:18px; height:18px; border-radius:5px; background:var(--paper); border:1px solid var(--line); font:12px/1 var(--font); color:var(--muted); }
  ...
  .goal-event-document .timeline-type { display:inline-block; font-weight: 400; padding:1px 5px; background:var(--control-fill); border-radius:4px; }
  .goal-event-document .timeline-actor { margin-left:4px; }
  .goal-event-document .history-state { display:inline-flex; align-items:center; width:fit-content; padding:2px 6px; margin-top:5px; border:1px solid var(--line); border-radius:4px; font:400 11px/1.4 var(--font); color:var(--ink-soft); }
  ...
  .goal-event-document .history-relation-flow button { width:100%; padding:12px; white-space:normal; overflow-wrap:anywhere; text-align:left; font:400 13px/1.6 var(--font); background:var(--control-fill); color:var(--ink); border:1px solid var(--line); border-radius:6px; cursor:pointer; }
  .goal-event-document .history-relation-flow button:hover { border-color:var(--line-strong); }
  ...
  .goal-event-document .timeline-entry[aria-current="true"] { background: var(--nav-active); }
  .goal-event-document .timeline-copy { min-width: 0; }
  .goal-event-document .timeline-copy strong { display: -webkit-box; font-size: 11px; font-weight: 400; line-height: 1.55; overflow: hidden; -webkit-line-clamp: 2; -webkit-box-orient: vertical; }
  ...
  .goal-event-document .timeline-entry:focus-visible { outline: var(--focus-stroke); outline-offset: var(--focus-stroke-inset); }
  ...
  .goal-event-document .original-goal-criteria > summary { cursor: pointer; font-size: 12px; font-weight: 400; }
  ...
  .goal-event-document .event-form-status, .goal-event-document .event-field-error, .goal-event-document .event-conflict { color: var(--red); font-size: 12px; }
  ...
  .event-form-actions .mw-btn { min-height: 36px; }
  @media (max-width: 760px) { .event-form-actions .mw-btn { min-height: 44px; } }
`;
