...
允许改：`apps/workbench/src/styles/immersive-navigation.ts`、`specs/plugin-market-catalog/spec.md`；`tests/chrome-inner-scroll.test.ts`、`tests/plugin-market-catalog.test.ts`。
