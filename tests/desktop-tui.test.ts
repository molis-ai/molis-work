...
test("Web and Desktop share one project workbench; Desktop only adds native chrome hooks", () => {
  ...
  try {
    ...
    assert.doesNotMatch(desktop, /data-directory-open="goals"|data-directory-open="feed"|data-directory-open="sources"|data-directory-open="sessions"|data-feed-views/);
