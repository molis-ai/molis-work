...
export const GOAL_CANVAS_STYLES = `
  ...
  @container goal-board (max-width: 839px) {
    ...
    .goal-canvas-shell[data-board-view="kanban"] .goal-kanban-column > details > summary:focus-visible { outline: 2px solid var(--blue); outline-offset: 1px; }
    ...
    .goal-canvas-shell[data-board-view="kanban"] .goal-kanban-card:focus-visible { outline-offset: 0; }
  }
  @media (max-width: 760px) {
    @container goal-board (max-width: 839px) {
  ...
  .goal-details-toggle:focus-visible { outline: 2px solid var(--blue); outline-offset: 2px; }
