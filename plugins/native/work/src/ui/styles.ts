export const PROJECT_OPERATIONS_STYLES = `
  ...
  body[data-desktop-shell="true"] .project-record-directory .project-record-row:focus-visible { outline: var(--focus-stroke); outline-offset: var(--focus-stroke-inset); box-shadow: none; }
  ...
  .operation-content-search input:focus-visible { border-color: var(--ink); outline: var(--focus-stroke); outline-offset: var(--focus-stroke-inset); }
  ...
  .session-handoff-editor textarea:focus-visible { outline: var(--focus-stroke); outline-offset: var(--focus-stroke-inset); box-shadow: none; }
  ...
  .session-workspace-picker[open] > summary { border-color: var(--ink); }
