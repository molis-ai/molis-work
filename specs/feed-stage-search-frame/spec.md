...
同族先例：`specs/plugin-market-search-frame/spec.md`、`specs/global-search-field-flush/spec.md`。
...
允许改：`apps/workbench/src/styles/immersive-directory.ts`、`packages/design-system/src/styles/{calm-desktop,quiet-paper,momentum}.ts`、`specs/feed-stage-search-frame/spec.md`、`tests/chrome-inner-scroll.test.ts`。
