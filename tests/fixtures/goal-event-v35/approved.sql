...
INSERT INTO "events" VALUES(47,'2abf18de-a998-4a91-9bbc-d922db58334c','goalboard-v1-demo','mixed-user','goal.created','goal','MIXED-OWNER','创建新 Goal','{"definition_state":"draft","decomposition_state":"abstract"}','2026-09-10T07:29:38.098Z');
INSERT INTO "events" VALUES(48,'gevt-a47aa75e-722e-41ac-8896-e59373c12681','goalboard-v1-demo','mixed-runtime','goal.event_config.updated','goal_event_config','MIXED-OWNER','登记 Goal 局部事件配置','{"config_version":1,"types":[{"type_id":"check","version":1,"name":"实际核对","purpose":"保留真实支持","source":{"kind":"local","label":"当前 Goal 局部定义"},"fields":[{"field_id":"result","name":"结果","purpose":"核对结果","format":"text","required":true,"source":{"kind":"local"}}]}],"extra_requirements":[],"requirement_bindings":[],"adopted_planning":[]}','2026-09-10T07:29:38.102Z');
INSERT INTO "events" VALUES(49,'gevt-75b666e9-56d7-4929-b6d0-7474b5937be3','goalboard-v1-demo','mixed-runtime','goal.work_event.recorded','goal_work_event','gevt-75b666e9-56d7-4929-b6d0-7474b5937be3','结果核对','{"type_id":"check","type_version":1,"fields":{"result":"真实结果可以打开"},"judgments":[{"requirement_id":"MIXED-C1","verdict":"supports"}]}','2026-09-10T07:29:38.103Z');
INSERT INTO "events" VALUES(50,'0fc8c18e-4b3e-4606-8896-c093be12c247','goalboard-v1-demo','mixed-user','policy.added_from_tree_proposal','policy','mixed-project-human','本项目完成必须由用户验收','{"proposal_item_id":"old-policy-decision","goal_id":null,"scope":"project_default","replaced_binding_ids":[]}','2026-09-10T07:29:38.105Z');
INSERT INTO "events" VALUES(51,'gevt-f4b4a960-29b4-4e3b-861c-53a8c6501a7b','goalboard-v1-demo','existing-user','goal.event_state.user_decision','goal_work_event','gevt-f4b4a960-29b4-4e3b-861c-53a8c6501a7b','记录用户决定','{"operation":"user_decision","decision_id":"gdec-10ae30b3-8436-48de-97a4-2b547845901b","governance_decision_id":"gedec-97ffa149-4a53-4ae0-b46d-be5d90c43685","request_id":null,"selected_option_id":null,"conclusion":"我已经核对本 Goal 的当前交付，同意满足人工验收责任；剩余输入遗漏修复后可以完成","accepts_requirements":false,"effects":[{"kind":"authorize_action","action":"complete"}],"scope":{"requirement_ids":[],"event_ids":[],"concern_ids":[],"action":"complete"},"authorized_change":null,"config_version":1,"agreement_version":1}','2026-09-10T08:10:41.750Z');
INSERT INTO "events" VALUES(52,'gevt-5927be9a-4053-479e-b471-66b9cd948102','goalboard-v1-demo','existing-runtime','goal.event_state.closure_submitted','goal_work_event','gevt-5927be9a-4053-479e-b471-66b9cd948102','记录完成报告但未生效','{"operation":"closure_submitted","kind":"complete","result":"实际结果可读","reason":"保留真实人工批准，核对剩余风险","completion_applied":false,"unmet_reasons":[{"code":"event_closure.blocking_risk","message":"未解决的完成风险：交付输入尚有缺口","risk_id":"approved-completion-risk"}],"expected_config_version":1,"expected_agreement_version":1,"config_version":1,"agreement_version":1}','2026-09-10T08:10:41.753Z');
...
INSERT INTO "goal_contract_revisions" VALUES('MIXED-OWNER','goalboard-v1-demo',1,'{"goal_id":"MIXED-OWNER","title":"已有事件 owner 的旧要求","outcome":"真实结果继续有效","why":"旧 criterion 已有真实事件支持","business_logic":"单向迁移不得丢弃它","in_scope":[],"out_of_scope":[],"constraints":[],"required_inputs":[],"promised_outputs":[],"definition_state":"draft","decomposition_state":"abstract","priority":0,"acceptance_criteria":[{"criterion_id":"MIXED-C1","statement":"结果确实可读","decision_method":"inspection","pass_condition":"打开实际结果","target":null,"required_evidence":[]}]}','metadata',NULL,'mixed-user','创建 Goal Contract revision 1','2026-09-10T07:29:38.098Z');
...
INSERT INTO "goal_event_applied_decisions" VALUES('gdec-10ae30b3-8436-48de-97a4-2b547845901b','goalboard-v1-demo','MIXED-OWNER','gedec-97ffa149-4a53-4ae0-b46d-be5d90c43685',NULL,'gevt-f4b4a960-29b4-4e3b-861c-53a8c6501a7b',NULL,'我已经核对本 Goal 的当前交付，同意满足人工验收责任；剩余输入遗漏修复后可以完成',0,'[{"kind":"authorize_action","action":"complete"}]','{"requirement_ids":[],"event_ids":[],"concern_ids":[],"action":"complete"}','{"outcome":"真实结果继续有效","requirements":[]}',NULL,1,1,'existing-user','web','2026-09-10T08:10:41.750Z');
...
INSERT INTO "goal_event_closures" VALUES('gclo-3e70fd53-50ac-45e8-b8ca-9d5060ed4954','goalboard-v1-demo','MIXED-OWNER','gevt-5927be9a-4053-479e-b471-66b9cd948102','complete','实际结果可读','保留真实人工批准，核对剩余风险',0,1,1,1,1,'[{"code":"event_closure.blocking_risk","message":"未解决的完成风险：交付输入尚有缺口","risk_id":"approved-completion-risk"}]',0,NULL,'2026-09-10T08:10:41.753Z');
...
INSERT INTO "goal_event_state_owners" VALUES('goalboard-v1-demo','MIXED-OWNER','event_work','configuration','2026-09-10T07:29:38.102Z','mixed-runtime');
...
INSERT INTO "goal_event_trusted_decisions" VALUES('gedec-97ffa149-4a53-4ae0-b46d-be5d90c43685','goalboard-v1-demo','MIXED-OWNER','existing-user','user','web','web:goalboard-v1-demo','web-event-decision:approved-policy-before-migration',NULL,NULL,'我已经核对本 Goal 的当前交付，同意满足人工验收责任；剩余输入遗漏修复后可以完成',0,'{"requirement_ids":[],"event_ids":[],"concern_ids":[],"action":"complete"}',NULL,'2026-09-10T08:10:41.750Z');
...
INSERT INTO "goal_event_work_status" VALUES('goalboard-v1-demo','MIXED-OWNER','open','2026-09-10T07:29:38.102Z');
...
INSERT INTO "goal_risks" VALUES('MIXED-OWNER','mixed-shared-risk');
INSERT INTO "goal_risks" VALUES('OLD-HUMAN','mixed-shared-risk');
INSERT INTO "goal_risks" VALUES('MIXED-OWNER','approved-completion-risk');
...
INSERT INTO "goal_work_events" VALUES('gevt-a47aa75e-722e-41ac-8896-e59373c12681','goalboard-v1-demo','MIXED-OWNER','configuration',NULL,NULL,'新增记录方式：实际核对','{"config_version":1,"types":[{"type_id":"check","version":1,"name":"实际核对","purpose":"保留真实支持","source":{"kind":"local","label":"当前 Goal 局部定义"},"fields":[{"field_id":"result","name":"结果","purpose":"核对结果","format":"text","required":true,"source":{"kind":"local"}}]}],"extra_requirements":[],"requirement_bindings":[],"adopted_planning":[]}','mixed-runtime','runtime','2026-09-10T07:29:38.102Z',48,1);
INSERT INTO "goal_work_events" VALUES('gevt-75b666e9-56d7-4929-b6d0-7474b5937be3','goalboard-v1-demo','MIXED-OWNER','report','check',1,'结果核对','{"result":"真实结果可以打开"}','mixed-runtime','runtime','2026-09-10T07:29:38.103Z',49,1);
INSERT INTO "goal_work_events" VALUES('gevt-f4b4a960-29b4-4e3b-861c-53a8c6501a7b','goalboard-v1-demo','MIXED-OWNER','system',NULL,NULL,'记录用户决定','{"operation":"user_decision","decision_id":"gdec-10ae30b3-8436-48de-97a4-2b547845901b","governance_decision_id":"gedec-97ffa149-4a53-4ae0-b46d-be5d90c43685","request_id":null,"selected_option_id":null,"conclusion":"我已经核对本 Goal 的当前交付，同意满足人工验收责任；剩余输入遗漏修复后可以完成","accepts_requirements":false,"effects":[{"kind":"authorize_action","action":"complete"}],"scope":{"requirement_ids":[],"event_ids":[],"concern_ids":[],"action":"complete"},"authorized_change":null,"config_version":1,"agreement_version":1}','existing-user','user','2026-09-10T08:10:41.750Z',51,1);
INSERT INTO "goal_work_events" VALUES('gevt-5927be9a-4053-479e-b471-66b9cd948102','goalboard-v1-demo','MIXED-OWNER','system',NULL,NULL,'记录完成报告但未生效','{"operation":"closure_submitted","kind":"complete","result":"实际结果可读","reason":"保留真实人工批准，核对剩余风险","completion_applied":false,"unmet_reasons":[{"code":"event_closure.blocking_risk","message":"未解决的完成风险：交付输入尚有缺口","risk_id":"approved-completion-risk"}],"expected_config_version":1,"expected_agreement_version":1,"config_version":1,"agreement_version":1}','existing-runtime','runtime','2026-09-10T08:10:41.753Z',52,1);
CREATE TABLE goals (
...
INSERT INTO "goals" VALUES('MIXED-OWNER','goalboard-v1-demo','已有事件 owner 的旧要求','真实结果继续有效','旧 criterion 已有真实事件支持','单向迁移不得丢弃它','[]','[]','[]','[]','[]',NULL,'draft','abstract','valid','unmet',1,NULL,NULL,NULL,NULL,0,NULL,NULL,'2026-09-10T07:29:38.098Z','2026-09-10T07:29:38.098Z');
...
INSERT INTO "idempotency_records" VALUES('goalboard-v1-demo','mixed-user','create_goal','mixed-old-create','04add0af3796bcff04fca4c56665fa6e364377711fc68ec45eef006bf281c9b2','{"goal":{"goal_id":"MIXED-OWNER","board_id":"goalboard-v1-demo","title":"已有事件 owner 的旧要求","outcome":"真实结果继续有效","why":"旧 criterion 已有真实事件支持","business_logic":"单向迁移不得丢弃它","in_scope":[],"out_of_scope":[],"constraints":[],"required_inputs":[],"promised_outputs":[],"decomposition_review":null,"definition_state":"draft","decomposition_state":"abstract","validity_state":"valid","fulfillment_state":"unmet","current_contract_revision":1,"trashed_at":null,"trashed_by":null,"archived_at":null,"archived_by":null,"priority":0,"accepted_by":null,"accepted_at":null,"created_at":"2026-09-10T07:29:38.098Z","updated_at":"2026-09-10T07:29:38.098Z","acceptance_criteria":[{"criterion_id":"MIXED-C1","goal_id":"MIXED-OWNER","statement":"结果确实可读","decision_method":"inspection","pass_condition":"打开实际结果","target":null,"required_evidence":[]}]},"observed_event_cursor":47}','2026-09-10T07:29:38.098Z');
...
INSERT INTO "idempotency_records" VALUES('goalboard-v1-demo','existing-user','record_goal_user_decision','approved-policy-before-migration','1acadeefc733972f0eb553106ceea508a907f9d2c506d3d31956d5c438896f0d','{"event_id":"gevt-f4b4a960-29b4-4e3b-861c-53a8c6501a7b","observed_event_cursor":51,"recorded":true,"decision":{"decision_id":"gdec-10ae30b3-8436-48de-97a4-2b547845901b","governance_decision_id":"gedec-97ffa149-4a53-4ae0-b46d-be5d90c43685","request_id":null,"selected_option_id":null,"conclusion":"我已经核对本 Goal 的当前交付，同意满足人工验收责任；剩余输入遗漏修复后可以完成","accepts_requirements":false,"effects":[{"kind":"authorize_action","action":"complete"}],"scope":{"requirement_ids":[],"event_ids":[],"concern_ids":[],"action":"complete"},"commitment":{"outcome":"真实结果继续有效","requirements":[]},"authorized_change":null,"config_version":1,"agreement_version":1,"actor_id":"existing-user","authority_source":"web","recorded_at":"2026-09-10T08:10:41.750Z"}}','2026-09-10T08:10:41.750Z');
INSERT INTO "idempotency_records" VALUES('goalboard-v1-demo','existing-runtime','submit_goal_event_closure','approved-still-blocked-by-risk','d7b4fc0c718e4590dfda9185ee19a2ba7bafeb0473f0133f3965121dea319629','{"event_id":"gevt-5927be9a-4053-479e-b471-66b9cd948102","observed_event_cursor":52,"recorded":true,"completion_applied":false,"work_status":"open","unmet_reasons":[{"code":"event_closure.blocking_risk","message":"未解决的完成风险：交付输入尚有缺口","risk_id":"approved-completion-risk"}],"closure":{"closure_id":"gclo-3e70fd53-50ac-45e8-b8ca-9d5060ed4954","event_id":"gevt-5927be9a-4053-479e-b471-66b9cd948102","kind":"complete","result":"实际结果可读","reason":"保留真实人工批准，核对剩余风险","recorded":true,"completion_applied":false,"expected_config_version":1,"expected_agreement_version":1,"config_version":1,"agreement_version":1,"unmet_reasons":[{"code":"event_closure.blocking_risk","message":"未解决的完成风险：交付输入尚有缺口","risk_id":"approved-completion-risk"}],"superseded":false,"superseded_reason":null,"recorded_at":"2026-09-10T08:10:41.753Z"}}','2026-09-10T08:10:41.753Z');
...
INSERT INTO "risks" VALUES('mixed-shared-risk','goalboard-v1-demo','共享输入记录仍有遗漏','已发生','结果无法核对','["当前结果"]','核对时','mitigate','补齐全部输入','invalidate_on_trigger','缺失记录全部补齐','mixed-user','open',NULL,'2026-09-10T07:29:38.106Z','2026-09-10T07:29:38.106Z');
INSERT INTO "risks" VALUES('approved-completion-risk','goalboard-v1-demo','交付输入尚有缺口','已发生','结果还不能完整核对','["当前结果"]','核对交付','mitigate','补齐缺口并检查','completion','输入全部补齐','existing-user','open',NULL,'2026-09-10T08:10:41.746Z','2026-09-10T08:10:41.746Z');
CREATE TABLE runs (
