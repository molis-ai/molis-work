...
状态：已完成，2026-09-17。完成等级 **3**（本机功能可用）。覆盖 `specs/archive/home-quote-autoplay/spec.md`、`specs/archive/poetic-project-home/spec.md` 与 `specs/archive/home-narrow-footer-quotes/spec.md` 里仍有效的引语合同。
