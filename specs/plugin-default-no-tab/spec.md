...
本文件修正 `specs/workbench-tab-workspace/spec.md` 与 `specs/additive-tabs/spec.md` 里「点插件 = 开母标签」的合同。分栏几何、item 标签、首页标签仍以那两份为准。
...
- `specs/workbench-tab-workspace/spec.md`、`specs/additive-tabs/spec.md` 里与母标签打开相关的句子
