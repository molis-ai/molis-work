import type { FunctionsPluginRouteResponse } from "./routes.js";

export function functionsRouteErrorResponse(error: unknown): FunctionsPluginRouteResponse {
  ...
  if (code.startsWith("functions.")) return { status: 400, body: { error: message, code } };
