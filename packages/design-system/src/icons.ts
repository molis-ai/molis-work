...
export const ICON_LIBRARY: ReadonlyArray<{ id: string; label: string; icons: readonly MolisWorkIcon[] }> = [
  {
    ...
    label: "栏",
    icons: [
      "home", "search", "settings", "more", "sidebar", "panel", "frame", "columns", "rows", "list",
  ...
  },
  {
    ...
    icons: [
      ...
      "file", "note", "folder", "folder-open", "image", "book", "library", "database", "code", "terminal",
      "message", "user", "review", "target", "tree", "workflow", "network", "globe", "rss", "cloud",
  ...
  },
  {
    ...
    icons: [
      ...
      "bell", "sparkles", "zap", "timer", "bug", "idea", "circle", "dot", "accepted", "completed",
