...
export const CONNECTOR_SETUP_LINKS = {
  ...
  notion: [
    link("创建 Notion Integration", "https://www.notion.so/my-integrations"),
    link("Notion OAuth 配置说明", "https://developers.notion.com/guides/get-started/authorization"),
  ],
  ...
  feishu: [
    ...
    link("安装与配置飞书官方 CLI", "https://github.com/larksuite/cli"),
  ],
  ...
  bitbucket: [link("创建 Atlassian API Token", "https://id.atlassian.com/manage-profile/security/api-tokens")],
  ...
  hubspot: [link("查看 HubSpot Service Key 创建方式", "https://developers.hubspot.com/changelog/service-keys")],
