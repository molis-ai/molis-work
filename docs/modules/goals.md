...
当前调用示例见 [Runtime](../runtime.md)、[MCP](../mcp.md) 与[仓库 Skill](../../skills/goal-advance/SKILL.md)。本轮行为和历史兼容的验收范围见[事件工作流需求书](../../specs/archive/goal-event-workflow-cleanup/spec.md)；早期 GW/DD/EX 迁移报告保留当时事实，不作为当前旧协议的使用指南。
