...
export const IMMERSIVE_NAVIGATION_STYLES = `
  body.immersive-workbench {
    ...
    --blue-soft: #efeffc; --focus: #6262d6; --nav-bg: #f8f9fb; --nav-active: #e9eaf0;
  ...
  html[data-resolved-theme="dark"] body.immersive-workbench {
    ...
    --blue-soft: #29283f; --focus: #a7a6f5; --nav-bg: #15161b; --nav-active: #282a33;
  ...
  body.immersive-workbench .immersive-directory-heading { flex: none; min-width: 0; padding: 6px 10px 2px; }
  body.immersive-workbench .immersive-directory-toolbar { display: flex; align-items: center; justify-content: space-between; gap: 8px; margin-bottom: 2px; }
  body.immersive-workbench .immersive-directory-back { display: flex; align-items: center; gap: 6px; min-height: 28px; padding: 4px; font: inherit; font-size: 10px; color: var(--muted); border: 0; border-radius: 5px; background: transparent; cursor: pointer; }
  body.immersive-workbench .immersive-directory-back svg { width: 13px; height: 13px; }
  body.immersive-workbench .immersive-plugin-strip { display: flex; min-width: 0; padding: 4px 2px 8px; overflow-x: auto; overscroll-behavior-x: contain; scrollbar-width: none; }
  body.immersive-workbench .immersive-plugin-strip::-webkit-scrollbar { display: none; }
  body.immersive-workbench .immersive-plugin-link { flex: none; display: flex; align-items: center; justify-content: center; min-height: 34px; padding: 7px; font: inherit; font-size: 11px; font-weight: 500; white-space: nowrap; border: 0; border-radius: 6px; background: transparent; color: var(--muted); cursor: pointer; }
  body.immersive-workbench .immersive-plugin-link[aria-current] { background: var(--nav-raised); color: var(--ink); font-weight: 600; box-shadow: var(--nav-shadow); }
  ...
  body.immersive-workbench .immersive-workspace .tree-chrome { padding: 0 2px 6px; background: transparent; border: 0; flex: none; }
  body.immersive-workbench .navigator-view-switch { display: none; }
  body.immersive-workbench .tree-search { display: flex; align-items: center; gap: 6px; min-height: 32px; padding: 7px 8px; background: transparent; border: 1px solid var(--line); border-radius: 6px; box-shadow: none; }
  body.immersive-workbench .tree-search input { font: inherit; font-size: 10px; padding: 0; border: 0; outline: none; background: transparent; color: var(--ink); flex: 1; min-width: 0; }
  body.immersive-workbench .tree-search svg { position: static; flex: none; width: 13px; height: 13px; color: var(--muted); }
  ...
  body.immersive-workbench .tree-search:focus-within { border-color: var(--blue); }
  ...
  body.immersive-workbench :is(.immersive-icon-button, .immersive-directory-back, .immersive-plugin-link, .immersive-market-entry, .navigator-directory-toggle, .navigator-project-selector, .tree-tool):hover { background: var(--nav-active); color: var(--ink); }
  ...
  @media (max-width: 600px) {
    ...
    body.immersive-workbench .immersive-directory-back, body.immersive-workbench .immersive-plugin-link { min-height: 44px; }
    body.immersive-workbench .immersive-strip-scroll button { width: 32px; min-height: 44px; }
