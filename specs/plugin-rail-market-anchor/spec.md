...
允许改：`apps/workbench/src/styles/immersive-navigation.ts`、`specs/chrome-plugin-rail/spec.md`；`tests/chrome-inner-scroll.test.ts`、`tests/immersive-directory.e2e.test.ts`。
