...
INSERT INTO "events" VALUES(51,'gevt-c3a48804-b9f3-4b0f-9a75-2393f0881092','goalboard-v1-demo','existing-user','goal.event_state.user_decision','goal_work_event','gevt-c3a48804-b9f3-4b0f-9a75-2393f0881092','记录用户决定','{"operation":"user_decision","decision_id":"gdec-83564492-8f53-45d4-9c70-7cd39039fc2a","governance_decision_id":"gedec-fe7294b3-8446-424e-9418-2932bb8027d9","request_id":null,"selected_option_id":null,"conclusion":"我已经核对本 Goal 的当前交付，同意满足人工验收责任；剩余输入遗漏修复后可以完成","accepts_requirements":false,"effects":[{"kind":"authorize_action","action":"complete"}],"scope":{"requirement_ids":[],"event_ids":[],"concern_ids":[],"action":"complete"},"authorized_change":null,"config_version":1,"agreement_version":1}','2026-09-10T08:08:53.175Z');
INSERT INTO "events" VALUES(52,'gevt-fff26575-8687-4006-bc0a-652b335c236f','goalboard-v1-demo','existing-runtime','goal.event_state.closure_submitted','goal_work_event','gevt-fff26575-8687-4006-bc0a-652b335c236f','显式完成当前 Goal','{"operation":"closure_submitted","kind":"complete","result":"实际结果可读","reason":"保留真实人工批准，核对剩余风险","completion_applied":true,"unmet_reasons":[],"expected_config_version":1,"expected_agreement_version":1,"config_version":1,"agreement_version":1}','2026-09-10T08:08:53.178Z');
...
INSERT INTO "goal_event_work_status" VALUES('goalboard-v1-demo','MIXED-OWNER','completed','2026-09-10T08:08:53.178Z');
...
INSERT INTO "goal_work_events" VALUES('gevt-c3a48804-b9f3-4b0f-9a75-2393f0881092','goalboard-v1-demo','MIXED-OWNER','system',NULL,NULL,'记录用户决定','{"operation":"user_decision","decision_id":"gdec-83564492-8f53-45d4-9c70-7cd39039fc2a","governance_decision_id":"gedec-fe7294b3-8446-424e-9418-2932bb8027d9","request_id":null,"selected_option_id":null,"conclusion":"我已经核对本 Goal 的当前交付，同意满足人工验收责任；剩余输入遗漏修复后可以完成","accepts_requirements":false,"effects":[{"kind":"authorize_action","action":"complete"}],"scope":{"requirement_ids":[],"event_ids":[],"concern_ids":[],"action":"complete"},"authorized_change":null,"config_version":1,"agreement_version":1}','existing-user','user','2026-09-10T08:08:53.175Z',51,1);
INSERT INTO "goal_work_events" VALUES('gevt-fff26575-8687-4006-bc0a-652b335c236f','goalboard-v1-demo','MIXED-OWNER','system',NULL,NULL,'显式完成当前 Goal','{"operation":"closure_submitted","kind":"complete","result":"实际结果可读","reason":"保留真实人工批准，核对剩余风险","completion_applied":true,"unmet_reasons":[],"expected_config_version":1,"expected_agreement_version":1,"config_version":1,"agreement_version":1}','existing-runtime','runtime','2026-09-10T08:08:53.178Z',52,1);
CREATE TABLE goals (
...
INSERT INTO "goals" VALUES('MIXED-OWNER','goalboard-v1-demo','已有事件 owner 的旧要求','真实结果继续有效','旧 criterion 已有真实事件支持','单向迁移不得丢弃它','[]','[]','[]','[]','[]',NULL,'draft','abstract','valid','satisfied',1,NULL,NULL,NULL,NULL,0,NULL,NULL,'2026-09-10T07:29:38.098Z','2026-09-10T08:08:53.178Z');
