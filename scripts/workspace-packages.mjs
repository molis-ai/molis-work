...
export const WORKSPACE_PACKAGES = [
  ...
  entry("apps/workbench", "@molis-ai/molis-work-app-workbench", "app", "@molis-ai/molis-work-contracts/platform/app-host", ["goal-reorg-fd4", "goal-reorg-ap3", "goal-reorg-gw4", "goal-reorg-gw5", "goal-reorg-ex4"], "Local product UI composition root for the Workbench.", "Business Stores, Node-only implementations, or Tauri commands.", ["src/web/"], { maturity: "partial", capabilities: ["workbench.shell.v1", "workbench.ui-slots.v1", "workbench.feed-composition.v1", "workbench.goals-command-adapter.v1", "workbench.work-composition.v1", "workbench.goals-policy-composition.v1", "workbench.goals-safety-composition.v1", "workbench.goals-relation-composition.v1", "workbench.goals-tree-composition.v1", "workbench.goals-momentum-composition.v1", "workbench.goals-document-composition.v1", "workbench.goals-context-composition.v1", "workbench.goals-planning-composition.v1", "workbench.goals-status-composition.v1", "workbench.goals-factors-composition.v1", "workbench.goals-dialogs-composition.v1", "workbench.goals-document-routes.v1"], extraWorkspaceDependencies: ["@molis-ai/molis-work-plugin-artifacts", "@molis-ai/molis-work-plugin-goals", "@molis-ai/molis-work-plugin-feed", "@molis-ai/molis-work-plugin-inbox", "@molis-ai/molis-work-plugin-task", "@molis-ai/molis-work-plugin-work", "@molis-ai/molis-work-ui-host", "@molis-ai/molis-work-design-system", "@molis-ai/molis-work-integration-rss", "@molis-ai/molis-work-integration-gmail"] }),
  entry("apps/local-host", "@molis-ai/molis-work-app-local-host", "app", "@molis-ai/molis-work-contracts/platform/app-host", ["goal-reorg-ap2"], "The single local composition root for Modules, services, plugins, and storage.", "A second business coordinator or user-facing product shell.", ["apps/desktop/launchers/web/server.ts", "src/cli/", "src/mcp/"], { maturity: "partial", extraDependencies: { "ws": "^8.21.3", "@adeptify/search-evidence-layer": "file:../../vendor/search-evidence-layer/adeptify-search-evidence-layer-0.4.1.tgz", "@adeptify/intelligence-client": "file:../../vendor/intelligence-client/adeptify-intelligence-client-0.2.2.tgz" }, capabilities: ["local-host.client.v1", "local-host.single-writer.v1"], extraWorkspaceDependencies: ["@molis-ai/molis-work-app-cli", "@molis-ai/molis-work-plugin-work", "@molis-ai/molis-work-service-runtime-host", "@molis-ai/molis-work-service-connector-host", "@molis-ai/molis-work-integration-github", "@molis-ai/molis-work-integration-gmail", "@molis-ai/molis-work-integration-rss", "@molis-ai/molis-work-integration-youtube", "@molis-ai/molis-work-plugin-feed", "@molis-ai/molis-work-plugin-inbox", "@molis-ai/molis-work-plugin-task", "@molis-ai/molis-work-module-projects", "@molis-ai/molis-work-app-workbench", "@molis-ai/molis-work-plugin-goals", "@molis-ai/molis-work-storage", "@molis-ai/molis-work-module-artifacts", "@molis-ai/molis-work-module-evidence-verification", "@molis-ai/molis-work-module-execution", "@molis-ai/molis-work-module-governance-collaboration", "@molis-ai/molis-work-module-feed", "@molis-ai/molis-work-module-sources", "@molis-ai/molis-work-module-signals", "@molis-ai/molis-work-module-attention-resumption", "@molis-ai/molis-work-module-task", "@molis-ai/molis-work-service-listener-host", "@molis-ai/molis-work-app-mcp", "@molis-ai/molis-work-kernel", "@molis-ai/molis-work-module-context-ledger", "@molis-ai/molis-work-module-goals", "@molis-ai/molis-work-module-private-work-context", "@molis-ai/molis-work-plugin-artifacts", "@molis-ai/molis-work-plugin-runtime", "@molis-ai/molis-work-ui-host"] }),
...
entry("modules/context-ledger", "@molis-ai/molis-work-module-context-ledger", "module", "@molis-ai/molis-work-contracts/modules/context-ledger", ["goal-reorg-ar2"], "Object references, cross-owner relationships, publication, and materialization records.", "The referenced Goal, Artifact, Feed, or Session content.", ["src/v1/coordinator.ts", "src/feed/", "src/sessions/"], { maturity: "partial", capabilities: ["context.edges.v1"] }),
  ...
  entry("modules/task", "@molis-ai/molis-work-module-task", "module", "@molis-ai/molis-work-contracts/modules/task", [], "Task identity, optional Goal link, and Frame composition facts.", "Goal events, Session/Feed/Artifact bodies, or workbench chrome.", [], { maturity: "partial", capabilities: ["task.query.v1", "task.command.v1"] }),
