...
export const IMMERSIVE_NAVIGATION_STYLES = `
  ...
  body.immersive-workbench .immersive-plugin-stage > .desktop-work-surface:not(.session-stage-shell) { min-height: 0; background: var(--paper); padding: 32px clamp(18px, 4%, 56px); }
