...
允许：`specs/shelf-settings-flatten/`；`specs/shelf-plugin/spec.md`；`plugins/native/shelf/src/settings-ui.ts`、`settings-client.ts`、`styles.ts`；`plugins/native/shelf/README.md`；`tests/plugin-global-settings.test.ts`；`tests/shelf-plugin.e2e.test.ts`；对照图 README。
