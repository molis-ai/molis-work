...
entry("modules/context-ledger", "@molis-ai/molis-work-module-context-ledger", "module", "@molis-ai/molis-work-contracts/modules/context-ledger", ["goal-reorg-ar2"], "Object references, cross-owner relationships, publication, and materialization records.", "The referenced Goal, Artifact, Feed, or Session content.", ["src/v1/coordinator.ts", "src/feed/", "src/sessions/"], { maturity: "partial", capabilities: ["context.edges.v1"] }),
  ...
  entry("modules/functions", "@molis-ai/molis-work-module-functions", "module", "@molis-ai/molis-work-contracts/modules/functions", [], "Published functions and judgment records.", "TypeSafe HTTP, plugin UI, or scene execution.", [], { extraWorkspaceDependencies: ["@molis-ai/molis-work-storage"], maturity: "partial", capabilities: ["functions.query.v1", "functions.command.v1", "functions.evaluate"] }),
  ...
  entry("plugins/native/form", "@molis-ai/molis-work-plugin-form", "native-plugin", "@molis-ai/molis-work-contracts/platform/plugin", [], "Protected first-party Forms directory, questions, preview, and results.", "Goal/Artifact facts, model providers, or a hosted form collector.", ["src/web/render.ts"], { extraWorkspaceDependencies: ["@molis-ai/molis-work-design-system", "@molis-ai/molis-work-storage"], maturity: "partial", capabilities: ["form.ui-contribution.v1", "form.http-routes.v1"] }),
